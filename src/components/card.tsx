...
const Card: React.FC<CardProps> = ({ movie }) => (
    <div className="max-w-m rounded-md overflow-hidden shadow-lg shadow-slate-800/50 m-2 bg-gradient-to-r from-sky-900/80 to-cyan-700/90">
        <div className="h-100 border border-slate-800 overflow-hidden">
            <Image className="w-full object-cover brightness-90 hover:brightness-105 hover:scale-105" src={movie.imageUrl} alt={movie.title} width="400" height="400" />
        </div>
        <div className="px-6 py-4">
            <h2 className="text-white font-bold text-2xl mb-2">{movie.title}</h2>
